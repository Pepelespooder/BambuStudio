...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionInts,               darkmoon_g10_plate_temp))
    ((ConfigOptionInts,               darkmoon_ice_plate_temp))
    ((ConfigOptionInts,               darkmoon_lux_plate_temp))
    ((ConfigOptionInts,               darkmoon_cfx_plate_temp))
    ((ConfigOptionInts,               darkmoon_satin_plate_temp))
    ...
    ((ConfigOptionInts,               darkmoon_g10_plate_temp_initial_layer))
    ((ConfigOptionInts,               darkmoon_ice_plate_temp_initial_layer))
    ((ConfigOptionInts,               darkmoon_lux_plate_temp_initial_layer))
    ((ConfigOptionInts,               darkmoon_cfx_plate_temp_initial_layer))
    ((ConfigOptionInts,               darkmoon_satin_plate_temp_initial_layer))
