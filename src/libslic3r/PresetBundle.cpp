    ...
    std::optional<std::vector<int>> filament_maps_new)
{
    ...
    if (num_filaments <= 1) {
        ...
        DarkmoonConfigApp::apply_dynamic_config(filament_config, "", extruder_count);
        ...
        for (size_t i = 0; i < num_filaments; ++i) {
            ...
            // Apply dynamic darkmoon configuration to ensure proper temperatures
            DarkmoonConfigApp::apply_dynamic_config(filament_temp_configs[i], "", extruder_count);
    ...
    // Apply dynamic darkmoon configuration to ensure proper temperatures  
    DarkmoonConfigApp::apply_dynamic_config(out, "", extruder_count);
